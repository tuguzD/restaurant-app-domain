...
public class ReadAllServiceItemUseCase(serviceItemRepository: ServiceItemDataRepositoryService) :
    ReadAllUseCase<NanoId, ServiceItemData>(serviceItemRepository)
