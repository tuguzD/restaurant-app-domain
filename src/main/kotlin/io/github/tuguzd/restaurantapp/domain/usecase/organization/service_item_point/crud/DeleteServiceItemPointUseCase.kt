...
public class DeleteServiceItemPointUseCase(serviceItemPointRepository: ServiceItemPointDomainRepository) :
    DeleteUseCase<NanoId, ServiceItemPoint>(serviceItemPointRepository)
