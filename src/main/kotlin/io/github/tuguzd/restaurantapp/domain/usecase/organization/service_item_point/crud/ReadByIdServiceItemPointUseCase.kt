...
public class ReadByIdServiceItemPointUseCase(serviceItemPointRepository: ServiceItemPointDomainRepository) :
    ReadByIdUseCase<NanoId, ServiceItemPoint>(serviceItemPointRepository)
